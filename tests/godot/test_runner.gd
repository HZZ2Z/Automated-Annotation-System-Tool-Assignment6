...
const MODEL_ASSIST_CANDIDATE_TEST = preload("res://tests/godot/test_model_assist_candidate.gd")
const MODEL_ASSIST_SESSION_TEST = preload("res://tests/godot/test_model_assist_session.gd")
const MODEL_ASSIST_PLUGIN_TEST = preload("res://tests/godot/test_model_assist_plugin.gd")
const MODEL_ASSIST_UI_TEST = preload("res://tests/godot/test_model_assist_ui.gd")
...
const ENDOSCAPES_SOURCE_TEST = preload("res://tests/godot/test_endoscapes_source.gd")
const COCO_RLE_TEST = preload("res://tests/godot/test_coco_rle.gd")
...
const WORKSPACE_CATALOG_CONTROLLER_TEST = preload(
	"res://tests/godot/test_workspace_catalog_controller.gd")
...
func _run_tests() -> void:
	...
	await preload("res://tests/godot/test_batch_persistence_recovery.gd").new().run(support)
	...
	MODEL_ASSIST_CANDIDATE_TEST.run_suite(support)
	MODEL_ASSIST_SESSION_TEST.run_suite(support)
	MODEL_ASSIST_PLUGIN_TEST.run_suite(support)
	await MODEL_ASSIST_UI_TEST.run_suite(support, self)
	...
	ENDOSCAPES_SOURCE_TEST.new().run(support)
	COCO_RLE_TEST.new().run(support)
	...
	await WORKSPACE_CATALOG_CONTROLLER_TEST.new().run(support, self)
